...
USE `jobsDB`;
DROP procedure IF EXISTS `jobsDB`.`addData`;

DELIMITER $$
USE `jobsDB`$$
CREATE PROCEDURE `addData` (IN printer VarCHAR(30), in  columnname Varchar(25), in fielddata Varchar(30),in  buildname Varchar(150))
BEGIN
Declare col Int;
SET @sql = NULL;
set @dta = fielddata;
set @build=buildname;
SELECT column_names_id from custom_printer_column_names Where printer_name= printer And custom_field_name= columnname INTO col;
set @col = col;
SET @sql = ('insert into column_build_data ( build_name, column_name_id, column_field_data) values (@build,?, @dta) ');
...
START TRANSACTION;
USE `jobsDB`;
INSERT INTO `jobsDB`.`admin` (`username`, `date_created`, `pass`) VALUES ('Admin', 'now()', 'b109f3bbbc244eb82441917ed06d618b9008dd09b3befd1b5e07394c706a8bb980b1d7785e5976ec049b46df5f1326af5a2ea6d103fd07c95385ffab0cacbc86');
