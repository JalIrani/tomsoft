...
public class UtilController
{
    ...
    public static void print(ArrayList<ArrayList<Object>> q)
    {
    ...
    public static void updateAdminPassword(String input)
    {
		secretAdminHash(input);
    }

	private static void secretAdminHash(String input)
	{
	...
	public static boolean checkAdminLogin(String input)
	{
		return secretCheckAdminLogin(input);
	}
	
    private static boolean secretCheckAdminLogin(String input)
    {
